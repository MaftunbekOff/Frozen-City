...
pub fn building_name(k: BuildingKind, l: Lang) -> &'static str {
    match (k, l) {
        ...
        (BuildingKind::TailorShop, Lang::Uz) => "Tikuvxona",
        (BuildingKind::TailorShop, Lang::En) => "Tailor Shop",
        (BuildingKind::TailorShop, Lang::Ru) => "Швейная мастерская",
        (BuildingKind::Wall, Lang::Uz) => "Devor",
        (BuildingKind::Wall, Lang::En) => "Wall",
        (BuildingKind::Wall, Lang::Ru) => "Стена",
        (BuildingKind::Gate, Lang::Uz) => "Darvoza",
        (BuildingKind::Gate, Lang::En) => "Gate",
        (BuildingKind::Gate, Lang::Ru) => "Ворота",
        (BuildingKind::Well, Lang::Uz) => "Quduq",
        (BuildingKind::Well, Lang::En) => "Well",
        (BuildingKind::Well, Lang::Ru) => "Колодец",
        (BuildingKind::Farmhouse, Lang::Uz) => "Fermaxona",
        (BuildingKind::Farmhouse, Lang::En) => "Farmhouse",
        (BuildingKind::Farmhouse, Lang::Ru) => "Ферма",
        (BuildingKind::SnowCrew, Lang::Uz) => "Qor brigadasi",
        (BuildingKind::SnowCrew, Lang::En) => "Snow Crew",
        (BuildingKind::SnowCrew, Lang::Ru) => "Снегоуборщики",
...
pub fn building_desc(k: BuildingKind, l: Lang) -> &'static str {
    match (k, l) {
        ...
        (BuildingKind::Kitchen, Lang::Uz) => "Ishchili bo'lsa: shahar oziq va suvni tejamli iste'mol qiladi.",
        (BuildingKind::Kitchen, Lang::En) => "Staffed: the city eats and drinks more efficiently.",
        (BuildingKind::Kitchen, Lang::Ru) => "С персоналом: город расходует еду и воду экономнее.",
        ...
        (BuildingKind::TailorShop, Lang::Uz) => "Teridan mato tikadi. Ishchilar mo'ynani kiyimga aylantiradi.",
        (BuildingKind::TailorShop, Lang::En) => "Turns fur into cloth. Workers turn hides into warmth.",
        (BuildingKind::TailorShop, Lang::Ru) => "Превращает мех в ткань. Рабочие шьют тёплую одежду.",
        (BuildingKind::Wall, Lang::Uz) => "Chegarani belgilaydi. Dekorativ.",
        (BuildingKind::Wall, Lang::En) => "Marks a boundary. Decorative.",
        (BuildingKind::Wall, Lang::Ru) => "Отмечает границу. Декоративно.",
        (BuildingKind::Gate, Lang::Uz) => "Devor qatoridagi kirish joyi. Dekorativ.",
        (BuildingKind::Gate, Lang::En) => "An opening in a wall line. Decorative.",
        (BuildingKind::Gate, Lang::Ru) => "Проём в линии стены. Декоративно.",
        (BuildingKind::Well, Lang::Uz) => "Ishchilar suv tortadi. Shahar suvsiz yashay olmaydi.",
        (BuildingKind::Well, Lang::En) => "Workers draw water. The city needs it to survive.",
        (BuildingKind::Well, Lang::Ru) => "Рабочие качают воду. Город не выживет без неё.",
        (BuildingKind::Farmhouse, Lang::Uz) => "Ishchilar sigir va qo'y boqib, oziq yetkazadi.",
        (BuildingKind::Farmhouse, Lang::En) => "Workers raise cattle and sheep for food.",
        (BuildingKind::Farmhouse, Lang::Ru) => "Рабочие разводят коров и овец ради еды.",
        (BuildingKind::SnowCrew, Lang::Uz) => "Ishchi qo'ysang, atrofdagi qorni tozalab turadi — yo'llar ochiq qoladi.",
        (BuildingKind::SnowCrew, Lang::En) => "Staffed: keeps the snow down nearby, so the roads stay open.",
        (BuildingKind::SnowCrew, Lang::Ru) => "С рабочими: убирает снег вокруг, дороги остаются открытыми.",
...
pub fn profession_name(p: Profession, l: Lang) -> &'static str {
    match (p, l) {
        ...
        (Profession::Tailor, Lang::Uz) => "Tikuvchi",
        (Profession::Tailor, Lang::En) => "Tailor",
        (Profession::Tailor, Lang::Ru) => "Портной",
    }
}
...
pub fn tech_desc(t: Tech, l: Lang) -> &'static str {
    match (t, l) {
        ...
        (Tech::Rationing, Lang::Uz) => "Shahar oziq va suvni tejamliroq iste'mol qiladi.",
        (Tech::Rationing, Lang::En) => "The city eats and drinks more carefully.",
        (Tech::Rationing, Lang::Ru) => "Город расходует еду и воду более экономно.",
